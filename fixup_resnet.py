...
Based on the code of the paper "Fast Axiomatic Attribution for Neural Networks": https://github.com/visinf/fast-axiomatic-attribution/blob/main/imagenet/models/fixup_resnet.py
